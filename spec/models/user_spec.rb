...
describe User do
  ...
  describe "when email format is valid" do
    it "should be valid" do
      addresses = %w[user@FOO.com USER_p-x@foo.b.org example.user@foo.ex foo+bar@bar.co]
  ...
  describe "when email address is not unique (already taken)" do
    before do
  ...
  describe "check return value of authenticate method" do
    before { @user.save }
    ...
    describe "with invalid password" do
      let(:retval_for_invalid_password) { found_user.authenticate("invalid_password") }
      it { should_not == retval_for_invalid_password }
      specify { retval_for_invalid_password.should be_false }
    end
  ...
  describe "micropost associations" do
    ...
    it "should destroy all the associated microposts" do
